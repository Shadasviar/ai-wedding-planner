...
- **S-02: View guest list with cost breakdown** — Archived 2026-06-26 → `context/archive/2026-06-13-view-guest-list/`. Lesson: list view with aggregate counts (headcount, not costs).
