...
- **S-01: Add first guest with cost** — Archived 2026-06-13 → `context/changes/add-first-guest/`. Lesson: guest CRUD without cost field (PRD gap — FR-005 not yet implemented).
