...
- [x] 3.1 TypeScript compiles: `npm run build` — 40c415d
- [x] 3.2 Route file exists at correct path — 40c415d
...
- [x] 6.1 TypeScript compiles: `npm run build` — 04a56f9
- [x] 6.2 Middleware file exists — 04a56f9
